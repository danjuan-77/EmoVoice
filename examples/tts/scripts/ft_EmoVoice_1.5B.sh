...
llm_path="/share/nlp/tuwenming/models/Qwen/Qwen2.5-1.5B"
...
# log settings
exp_name="emovoice_sft_ultravoice_emotion_all_1.5b"
...
ckpt_path=/share/nlp/tuwenming/models/Emovoice/pretrain/emovoice-1.5b # this line is for resuming training
...
# nohup bash ./examples/tts/scripts/ft_EmoVoice_1.5B.sh > /share/nlp/tuwenming/projects/UltraVoice_dev/logs/emovoice_sft_ultravoice_emotion_all_1.5b_$(date +%Y%m%d%H%M%S).log 2>&1 &